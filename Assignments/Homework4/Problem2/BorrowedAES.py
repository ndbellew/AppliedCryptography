...
class AES:
    ...
    def keySchedule(self, key, round):
        ...
        roundKey[0] = self.xor(
            words[0], self.gFunction(words[3], round)).zfill(8)
    ...
    def keyAddition(self, state, key):
        ...
        stateString = self.xor(
            stateString, keyString).zfill(len(stateString))
    ...
    def encryptFIPS197(self):
        ...
        desiredOutput = ["39", "25", "84", "1d", "02", "dc", "09",
            "fb", "dc", "11", "85", "97", "19", "6a", "0b", "32"]

        # Input plaintext/key as per FIPS-197 test
        state = ['32', '43', 'f6', 'a8', '88', '5a', '30', '8d',
